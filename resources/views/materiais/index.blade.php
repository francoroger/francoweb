...
@push('scripts_page')
  ...
  <script src="{{ asset('assets/modules/js/materiais/index.js') }}"></script>
  ...
  <script type="text/javascript">
    function excluirMaterial(id)
    {
      if (id) {
        $.ajax({
          url: "{{ route('materiais.destroy', '') }}/" + id,
...
@section('content')
  <div class="page">
    <div class="page-header">
      <h1 class="page-title font-size-26 font-weight-100">Materiais</h1>
      <div class="page-header-actions">
        <div class="btn-group btn-group-sm" aria-label="Ações" role="group">
          <a href="{{ route('materiais.create') }}" class="btn btn-info">
    ...
    <div class="page-content">
      <div class="panel">
        <div class="panel-body">
          <table class="table table-hover dataTable table-striped w-full" id="materiais-table" data-ajax="{{ route('materiais.ajax') }}" data-processing="true">
            <thead>
              <tr>
                <th>Descrição</th>
