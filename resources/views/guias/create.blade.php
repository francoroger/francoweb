        ...
        <div class="panel-body container-fluid">
          <div class="row">
            <div class="form-group col-md-9">
              ...
              <input type="text" class="form-control @error('nome') is-invalid @enderror" id="nome" name="nome" placeholder="Nome Fantasia / Apelido" value="{{ old('nome') }}" required />
              @error('nome')
          ...
          <div class="row">
            ...
            <div class="form-group col-md-3">
              <input type="text" class="form-control @error('celular3') is-invalid @enderror" id="celular3" name="celular3" placeholder="Celular Alternativo" value="{{ old('celular3') }}" data-plugin="mask" data-type="cellphone" />
              @error('celular2')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
