...
@section('content')
  <div class="page">
    <form class="panel" method="post" action="{{ route('guias.store') }}" autocomplete="off">
      @csrf
      <div class="page-header">
        <h1 class="page-title font-size-26 font-weight-100">Novo Guia</h1>
        <div class="page-header-actions">
          <div class="float-left mr-10">
            <input type="hidden" name="ativo" value="0">
            <input type="checkbox" id="ativo" name="ativo" data-plugin="switchery" value="1"
      ...
      <div class="page-content">
        <div class="panel-body container-fluid">
          <div class="row">
            <div class="form-group col-md-9">
              ...
              <input type="text" class="form-control @error('nome') is-invalid @enderror" id="nome" name="nome"
                placeholder="Nome Fantasia / Apelido" value="{{ old('nome') }}" required />
              @error('nome')
            ...
            <div class="form-group col-md-3">
              ...
              <div>
                <div class="radio-custom radio-default radio-inline">
                  <input type="radio" id="pessoa_fisica" name="tipopessoa" value="F"
                    {{ old('tipopessoa') == 'F' ? 'checked' : '' }} />
                  <label for="pessoa_fisica">Física</label>
                </div>
                <div class="radio-custom radio-default radio-inline">
                  <input type="radio" id="pessoa_juridica" name="tipopessoa" value="J"
                    {{ old('tipopessoa') == 'J' ? 'checked' : '' }} />
          ...
          <div class="row">
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('cpf') is-invalid @enderror" id="cpf" name="cpf"
                placeholder="CPF / CNPJ" value="{{ old('cpf') }}" />
              @error('cpf')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-md-9">
              ...
              <input type="text" class="form-control @error('rzsc') is-invalid @enderror" id="rzsc" name="rzsc"
                placeholder="Razão Social / Nome Completo" value="{{ old('rzsc') }}" />
              @error('rzsc')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="row">
            <div class="form-group col-md-3">
              <label class="form-control-label" for="tipocomissao">Tipo de Comissão <span
                  class="text-danger">*</span></label>
              <select class="form-control @error('tipocomissao') is-invalid @enderror" id="tipocomissao"
                name="tipocomissao" required>
                <option value=""></option>
                <option value="F" {{ old('tipocomissao') == 'F' ? ' selected' : '' }}>Fixa</option>
                <option value="V" {{ old('tipocomissao') == 'V' ? ' selected' : '' }}>Variável</option>
              </select>
              @error('tipocomissao')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
          ...
          <div class="row">
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('telefone') is-invalid @enderror" id="telefone"
                name="telefone" placeholder="Telefone Principal" value="{{ old('telefone') }}" data-plugin="mask"
                data-type="cellphone" />
              @error('telefone')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('celular') is-invalid @enderror" id="celular" name="celular"
                placeholder="Celular Principal" value="{{ old('celular') }}" data-plugin="mask" data-type="cellphone"
                required />
              @error('celular')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            <div class="form-group col-md-6">
              ...
              <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                placeholder="E-mail Principal" value="{{ old('email') }}" />
              @error('email')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="row">
            <div class="form-group col-md-3">
              <input type="text" class="form-control @error('telefone2') is-invalid @enderror" id="telefone2"
                name="telefone2" placeholder="Telefone Secundário" value="{{ old('telefone2') }}" data-plugin="mask"
                data-type="cellphone" />
              @error('telefone2')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            <div class="form-group col-md-3">
              <input type="text" class="form-control @error('celular2') is-invalid @enderror" id="celular2"
                name="celular2" placeholder="Celular Secundário" value="{{ old('celular2') }}" data-plugin="mask"
                data-type="cellphone" />
              @error('celular2')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
          ...
          <div class="row">
            <div class="form-group col-md-3">
              <input type="text" class="form-control @error('telefone3') is-invalid @enderror" id="telefone3"
                name="telefone3" placeholder="Telefone Alternativo" value="{{ old('telefone3') }}" data-plugin="mask"
                data-type="cellphone" />
              @error('telefone3')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            <div class="form-group col-md-3">
              <input type="text" class="form-control @error('celular3') is-invalid @enderror" id="celular3"
                name="celular3" placeholder="Celular Alternativo" value="{{ old('celular3') }}" data-plugin="mask"
                data-type="cellphone" />
              @error('celular2')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
          ...
          <div class="row">
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('cep') is-invalid @enderror" id="cep" name="cep"
                placeholder="CEP" value="{{ old('cep') }}" data-plugin="mask" data-pattern="00000-000" />
              @error('cep')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control @error('compl') is-invalid @enderror" id="compl" name="compl"
                placeholder="Complemento" value="{{ old('compl') }}" />
              @error('compl')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <textarea class="form-control @error('obs') is-invalid @enderror" id="obs" name="obs" rows="15"
                placeholder="Observações, comentários, notas...">{{ old('obs') }}</textarea>
              @error('obs')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
