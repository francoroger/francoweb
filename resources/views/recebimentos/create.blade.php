        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="form-group col-md-2">
              ...
              <input type="text" class="form-control @error('hora_receb') is-invalid @enderror" id="hora_receb" name="hora_receb" value="{{ old('hora_receb') }}" data-plugin="clockpicker" data-autoclose="true" required />
              @error('hora_receb')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-md-12">
              ...
              <select class="form-control @error('idcliente') is-invalid @enderror" id="idcliente" name="idcliente" data-plugin="select2" required>
                ...
                @foreach ($clientes as $cliente)
                  <option value="{{ $cliente->id }}"{{ old('idcliente') == $cliente->id ? ' selected' : '' }}{{ $cliente->ativo ? '' : ' disabled' }}>{{ $cliente->rzsc }} ({{ $cliente->nome }})</option>
                @endforeach
              </select>
              @error('idcliente')
                <span class="invalid-feedback" role="alert">
          ...
          <div class="row">
            <div class="form-group col-md-4">
              <label class="form-control-label" for="pesostotal">Peso Total <span class="text-danger">*</span></label>
              <div class="input-group">
                <input type="text" class="form-control @error('pesostotal') is-invalid @enderror" id="pesostotal" name="pesostotal" value="{{ old('pesostotal') }}" required />
            ...
            <div class="form-group col-md-8">
              ...
              <select class="form-control @error('idfornec') is-invalid @enderror" id="idfornec" name="idfornec" data-plugin="select2" required>
                <option value=""></option>
