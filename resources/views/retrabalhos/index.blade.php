...
@push('scripts_page')
  ...
  <script src="{{ asset('assets/modules/js/retrabalhos/index.js') }}"></script>
      ...
      if (id) {
        $.ajax({
          ...
          success: function(data) {
            var el = $("#retrabalhos-table").find("[data-id='" + id + "']");
    ...
    <div class="page-content">
      <div class="panel">
        <div class="panel-body">
          <table class="table table-hover dataTable table-striped w-full" id="retrabalhos-table"
            data-ajax="{{ route('retrabalhos.ajax') }}" data-processing="true">
            <thead>
              <tr>
