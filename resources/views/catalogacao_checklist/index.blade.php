    ...
    <div class="page-content">
      <div class="panel">
        <div class="panel-body">
          <table class="table table-hover dataTable table-striped w-full" id="catalogacao-checklist-table" data-ajax="{{ route('catalogacao_checklist.ajax') }}" data-processing="true">
            <thead>
              <tr>
                <th>Código</th>
                <th>Cliente</th>
