    ...
    <div class="page-header">
      <div class="row">
        ...
        <div class="col-md-3 text-right">
          <!-- Inprimir -->
          <form id="print-form" method="POST" action="{{ route('catalogacao_checklist.print', $catalogacao->id) }}"
          ...
          <button type="button" id="btn-print" class="btn btn-info btn-sm font-weight-400" onclick="event.preventDefault();
        ...
        <div class="col-md-12">
          ...
          <div class="fdropdown dropdown">
            ...
            <div class="dropdown-menu w-full animation-scale-up animation-top-left animation-duration-250 exampleFilter"
              ...
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="*"
                data-filter-type="filtro_produto" data-filter-value="">Todos os Produtos</a>
              <div class="dropdown-divider"></div>
              @foreach ($produtos as $i => $produto)
                <a class="dropdown-item" href="javascript:void(0)" role="menuitem" tabindex="-1"
                  data-filter="Produto_{{ $i }}" data-filter-type="filtro_produto"
                  data-filter-value="{{ $i }}">{{ $produto }}</a>
              @endforeach
            </div>
          </div>
          ...
          <div class="fdropdown dropdown">
            ...
            <div class="dropdown-menu w-full animation-scale-up animation-top-left animation-duration-250 exampleFilter"
              ...
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="*"
                data-filter-type="filtro_material" data-filter-value="">Todos os Materiais</a>
              <div class="dropdown-divider"></div>
              @foreach ($materiais as $i => $material)
                <a class="dropdown-item" href="javascript:void(0)" role="menuitem" tabindex="-1"
                  data-filter="Material_{{ $i }}" data-filter-type="filtro_material"
                  data-filter-value="{{ $i }}">{{ $material }}</a>
              @endforeach
            </div>
          </div>
          <div class="fspacer mx-5 my-5"></div>
          <div class="fdropdown dropdown">
            <button class="btn btn-block btn-secondary dropdown-toggle" type="button" id="status-menu"
              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Todas as Situações
            </button>
            <div class="dropdown-menu w-full animation-scale-up animation-top-left animation-duration-250 exampleFilter"
              aria-labelledby="status-menu" role="menu">
              <a class="dropdown-item {{ app('request')->input('status') ? '' : 'selected-item' }}"
                href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="*" data-filter-type="filtro_status"
                data-filter-value="">Todas as Situações</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item {{ app('request')->input('status') == 'V' ? 'selected-item' : '' }}"
                href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="Status_Verificado"
                data-filter-type="filtro_status" data-filter-value="V">Verificados</a>
              <a class="dropdown-item {{ app('request')->input('status') == 'S' ? 'selected-item' : '' }}"
                href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="Status_Aprovado"
                data-filter-type="filtro_status" data-filter-value="S">Aprovados</a>
              <a class="dropdown-item {{ app('request')->input('status') == 'N' ? 'selected-item' : '' }}"
                href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="Status_Reprovado"
                data-filter-type="filtro_status" data-filter-value="N">Reprovados</a>
              <a class="dropdown-item {{ app('request')->input('status') == 'P' ? 'selected-item' : '' }}"
                href="javascript:void(0)" role="menuitem" tabindex="-1" data-filter="Status_NaoVerificado"
                data-filter-type="filtro_status" data-filter-value="P">Não Verificados</a>
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem" tabindex="-1"
              ...
              <div
                ...
                <div class="info-wrap">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td class="p-10 font-weight-500 text-right" style="width: 15%;">Falha:</td>
                      <td class="p-10" style="width: 85%">{{ $item->tipo_falha->descricao ?? '' }}</td>
                    </tr>
                  </table>
                </div>
              </div>
