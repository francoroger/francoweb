            ...
            <div class="tab-pane active" id="tab-principal" role="tabpanel">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <input type="text" class="form-control @error('inscest') is-invalid @enderror" id="inscest" name="inscest" placeholder="Inscrição Estadual / RG" value="{{ old('inscest', $cliente->inscest) }}" />
                  @error('inscest')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <input type="email" class="form-control @error('email2') is-invalid @enderror" id="email2" name="email2" placeholder="E-mail Secundário" value="{{ old('email2', $cliente->email2) }}" />
                  @error('email2')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="tab-pane" id="tab-endereco" role="tabpanel">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-9">
                  ...
                  <input type="text" class="form-control @error('endereco') is-invalid @enderror" id="endereco" name="endereco" placeholder="Endereço" value="{{ old('endereco', $cliente->endereco) }}" />
                  @error('endereco')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-9">
                  ...
                  <input type="text" class="form-control @error('endereco_entrega') is-invalid @enderror" id="endereco_entrega" name="endereco_entrega" placeholder="Endereço" value="{{ old('endereco_entrega', $cliente->endereco_entrega) }}" />
              ...
              <div class="row">
                ...
                <div class="form-group col-md-2">
                  ...
                  <select class="form-control @error('uf_entrega') is-invalid @enderror" id="uf_entrega" name="uf_entrega">
                    <option value=""></option>
                    <option value="AC"{{ old('uf_entrega', $cliente->uf_entrega) == 'AC' ? ' selected' : '' }}>AC</option>
                    <option value="AL"{{ old('uf_entrega', $cliente->uf_entrega) == 'AL' ? ' selected' : '' }}>AL</option>
                    <option value="AP"{{ old('uf_entrega', $cliente->uf_entrega) == 'AP' ? ' selected' : '' }}>AP</option>
                    <option value="AM"{{ old('uf_entrega', $cliente->uf_entrega) == 'AM' ? ' selected' : '' }}>AM</option>
                    <option value="BA"{{ old('uf_entrega', $cliente->uf_entrega) == 'BA' ? ' selected' : '' }}>BA</option>
                    <option value="CE"{{ old('uf_entrega', $cliente->uf_entrega) == 'CE' ? ' selected' : '' }}>CE</option>
                    <option value="DF"{{ old('uf_entrega', $cliente->uf_entrega) == 'DF' ? ' selected' : '' }}>DF</option>
                    <option value="ES"{{ old('uf_entrega', $cliente->uf_entrega) == 'ES' ? ' selected' : '' }}>ES</option>
                    <option value="GO"{{ old('uf_entrega', $cliente->uf_entrega) == 'GO' ? ' selected' : '' }}>GO</option>
                    <option value="MA"{{ old('uf_entrega', $cliente->uf_entrega) == 'MA' ? ' selected' : '' }}>MA</option>
                    <option value="MT"{{ old('uf_entrega', $cliente->uf_entrega) == 'MT' ? ' selected' : '' }}>MT</option>
                    <option value="MS"{{ old('uf_entrega', $cliente->uf_entrega) == 'MS' ? ' selected' : '' }}>MS</option>
                    <option value="MG"{{ old('uf_entrega', $cliente->uf_entrega) == 'MG' ? ' selected' : '' }}>MG</option>
                    <option value="PA"{{ old('uf_entrega', $cliente->uf_entrega) == 'PA' ? ' selected' : '' }}>PA</option>
                    <option value="PB"{{ old('uf_entrega', $cliente->uf_entrega) == 'PB' ? ' selected' : '' }}>PB</option>
                    <option value="PR"{{ old('uf_entrega', $cliente->uf_entrega) == 'PR' ? ' selected' : '' }}>PR</option>
                    <option value="PE"{{ old('uf_entrega', $cliente->uf_entrega) == 'PE' ? ' selected' : '' }}>PE</option>
                    <option value="PI"{{ old('uf_entrega', $cliente->uf_entrega) == 'PI' ? ' selected' : '' }}>PI</option>
                    <option value="RJ"{{ old('uf_entrega', $cliente->uf_entrega) == 'RJ' ? ' selected' : '' }}>RJ</option>
                    <option value="RN"{{ old('uf_entrega', $cliente->uf_entrega) == 'RN' ? ' selected' : '' }}>RN</option>
                    <option value="RS"{{ old('uf_entrega', $cliente->uf_entrega) == 'RS' ? ' selected' : '' }}>RS</option>
                    <option value="RO"{{ old('uf_entrega', $cliente->uf_entrega) == 'RO' ? ' selected' : '' }}>RO</option>
                    <option value="RR"{{ old('uf_entrega', $cliente->uf_entrega) == 'RR' ? ' selected' : '' }}>RR</option>
                    <option value="SC"{{ old('uf_entrega', $cliente->uf_entrega) == 'SC' ? ' selected' : '' }}>SC</option>
                    <option value="SP"{{ old('uf_entrega', $cliente->uf_entrega) == 'SP' ? ' selected' : '' }}>SP</option>
                    <option value="SE"{{ old('uf_entrega', $cliente->uf_entrega) == 'SE' ? ' selected' : '' }}>SE</option>
                    <option value="TO"{{ old('uf_entrega', $cliente->uf_entrega) == 'TO' ? ' selected' : '' }}>TO</option>
                  </select>
                  @error('uf_entrega')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
