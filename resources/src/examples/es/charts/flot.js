...
(function() {
    ...
    $.plot(
        ...
        ],
        {
            ...
            colors: [
                Config.colors("light-green", 500),
                Config.colors("blue-grey", 300),
                Config.colors("primary", 500),
                Config.colors("purple", 500)
            ],
            xaxis: {
                tickLength: 0,
                color: "#474e54",
...
(function() {
    ...
    $("#exampleFlotVisitorsOverview").bind("plotselected", function(
        event,
        ranges
    ) {
