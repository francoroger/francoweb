  ...
  (function () {
    (0, _jquery2.default)(document).on('change', 'input[name="tipopessoa"]:checked', function () {
      if ((0, _jquery2.default)(this).val() == 'F') {
        ...
        (0, _jquery2.default)('label[for=nome]').text('Apelido');
        ...
        (0, _jquery2.default)('label[for=nome]').text('Nome Fantasia');
        ...
        (0, _jquery2.default)('label[for=nome]').text('Apelido / Nome Fantasia');
